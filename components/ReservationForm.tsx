...
const WHATSAPP_NUMBER = "573001112233"; // ⚠️ cambia este por el número del hotel
    ...
    <section id="contact" className="border-t border-white/10 bg-white/5">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 md:py-16">
        <div className="mb-8 max-w-xl">
          <h2 className="text-2xl font-semibold md:text-3xl">{texts.title}</h2>
        ...
        <div className="grid gap-8 md:grid-cols-[minmax(0,1.2fr),minmax(0,1fr)]">
          ...
          <form
            ...
            className="space-y-4 rounded-2xl border border-white/10 bg-black/40 p-4 shadow-lg sm:p-6"
          >
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/15 bg-black/40 px-3 py-2 text-sm text-white outline-none ring-0 focus:border-emerald-400"
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/15 bg-black/40 px-3 py-2 text-sm text-white outline-none focus:border-emerald-400"
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="h-24 w-full resize-none rounded-xl border border-white/15 bg-black/40 px-3 py-2 text-sm text-white outline-none focus:border-emerald-400"
            ...
            <button
              type="submit"
              className="mt-2 inline-flex w-full items-center justify-center rounded-full bg-emerald-500 px-6 py-3 text-sm font-medium text-black shadow-lg transition hover:bg-emerald-400"
            >
              {texts.button}
            </button>

            <p className="mt-2 text-[11px] text-gray-400">
              WhatsApp se abrirá con un mensaje prellenado. Solo tendrás que
              darle enviar.
            </p>
          </form>

          {/* Textito extra de confianza */}
